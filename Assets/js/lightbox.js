...
(function() {
  ...
  var Lightbox = (function() {
    ...
    Lightbox.prototype.start = function($link) {
      ...
      var top  = ((positionUnit.length > 1) ? windowPecentage * parseInt(positionUnit[0]) + $window.scrollTop() - $(".post").offset().top : $window.scrollTop()- $(".post").offset().top + parseInt(positionUnit[0]));
